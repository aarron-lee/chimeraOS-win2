...
You may encounter a bug where the screen is blank/black during the install process. Workaround is to plug in an external monitor, display via usb-c adapter should work fine too.
